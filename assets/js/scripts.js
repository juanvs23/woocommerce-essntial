...
var openSearchBtn = document.querySelector('#open-search-btn');
...
var mobilMinicart = document.querySelector('#cart-customlocation');
var openMinicartMobil = document.querySelector('#shopping-cart');
...
var searchOpen = function searchOpen(id) {
...
var collapseAll = function collapseAll(triggers) {
  triggers.forEach(function (trigger, i) {
    var parentList = Array.from(trigger.parentNode.children);
    ...
    parentList[0].addEventListener('click', function (e) {
      if (parentList[0].classList.contains('active')) {
...
document.addEventListener('DOMContentLoaded', function () {
  //top to up btn
  footer.appendChild(scrollBtn); //collpase
  ...
  cerradorBtn.addEventListener('click', function () {
...
__webpack_require__(/*! /home/juanvs23/proyectos/php/woocommerce-theme/wp-content/themes/ztgroup/src/js/scripts.js */"./src/js/scripts.js");
module.exports = __webpack_require__(/*! /home/juanvs23/proyectos/php/woocommerce-theme/wp-content/themes/ztgroup/src/sass/styles.scss */"./src/sass/styles.scss");
